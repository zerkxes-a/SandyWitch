...
public class SandwichBuilder {
    ...
    public static Sandwich buildCustom() {
        ...
        meatOptions.forEach(System.out::println);
        ...
        if (extraMeatSelection != null) toppings.add(new Topping("meat", meatSelection));
        //Loop to add cheese to sandwich
        List<String> cheeseOptions = Menu.getCheeseOptions();
        cheeseOptions.forEach(System.out::println);
        ...
        }if(extraCheeseSelection != null) toppings.add(new Topping("cheese", cheeseSelection));

        //tODO ADD LOOP FOR REGULAR DONE OR SKIP OPTION TOO
        List<String> regularOptions = Menu.getRegularOptions();
        regularOptions.forEach(System.out::println);
        ...
        sauceOptions.forEach(System.out::println);
